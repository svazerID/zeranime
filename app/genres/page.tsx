      ...
      <div className="flex flex-wrap gap-3 justify-center">
        {genres.map(genre => (
          <Link
            ...
            className="flex items-center justify-between gap-3 px-4 py-2 rounded-full border border-white/10 bg-[#0d1015] hover:border-[#a78bfa]/50 transition-colors shadow-sm"
          >
