...
export default function SearchClient() {
  ...
  // Keep the input in sync with the URL query
  useEffect(() => {
    setInputValue(q);
  }, [q]);
    ...
    return (
      <div className="flex flex-col items-center justify-center py-20">
        ...
        <button
          ...
          className="mt-2 px-4 py-2 bg-white/10 text-white rounded hover:bg-white/20"
        >
          Coba lagi
        </button>
      </div>
  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="mb-4">
        <form onSubmit={handleSubmit} className="relative max-w-xl mb-6">
          <input
            type="text"
            placeholder="Cari anime..."
            value={inputValue}
