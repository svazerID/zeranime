            ...
            <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
              ...
              <div className="grid grid-cols-2 max-w-[320px] mx-auto gap-y-4 gap-x-12 text-left mb-10 text-[15px] font-medium text-[#e6e6e6]">
                <div className="flex flex-col gap-4 items-start ml-auto">
                  <Link href="/terms" className="hover:text-[#ff9d00] transition-colors">Terms of Service</Link>
                  <Link href="/policy" className="hover:text-[#ff9d00] transition-colors">Policy</Link>
                  <Link href="/faq" className="hover:text-[#ff9d00] transition-colors">FAQs</Link>
                  <Link href="/contact" className="hover:text-[#ff9d00] transition-colors">Contact</Link>
                </div>
                <div className="flex flex-col gap-4 items-start">
                  <Link href="/movies" className="hover:text-[#ff9d00] transition-colors">Movies</Link>
                  <Link href="/tv-shows" className="hover:text-[#ff9d00] transition-colors">Tv shows</Link>
                  <Link href="/ongoing" className="hover:text-[#ff9d00] transition-colors">Animes</Link>
                  <Link href="/favorites" className="hover:text-[#ff9d00] transition-colors">Favorites</Link>
                </div>
              </div>

              <div className="w-full h-px bg-gradient-to-r from-transparent via-[#ff6a00]/80 to-transparent mb-8"></div>

              <div className="text-[#a9b7c6] space-y-4 text-[15px] leading-relaxed mx-auto max-w-4xl">
                <p>
                  <span className="text-[#ff9d00]">zeranime.vercel.app</span> is top of free streaming website, where to watch anime online free without registration required. 
